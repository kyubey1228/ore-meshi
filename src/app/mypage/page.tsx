...
export default async function MyPage() {
  ...
  return <section className="section"><div className="section-heading"><div><span className="eyebrow orange">MY TABLE</span><h1>マイページ</h1></div><div className="row">{data.businessMembership&&<Link className="text-link" href="/business">{data.businessMembership.businessAccount.name}の店舗管理</Link>}<Link className="text-link" href="/profile">プロフィール編集</Link><LogoutButton /></div></div>
