...
export function databaseTable(name: 'Meal' | 'User' | 'UserDiningType' | 'DiningType' | 'MealCandidate' | 'MealPurposeRelation' | 'MealPurpose' | 'JoinRequest' | 'SponsoredMeal' | 'BusinessAccount' | 'BusinessSubscription' | 'SeatCampaign' | 'AreaOption') {
