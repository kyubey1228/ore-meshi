...
export const GROWTH_EVENT_TYPES = [
  ...
  'INVITE_SHARE_CLICKED', 'INVITE_SHARE_COMPLETED', 'INVITE_LINK_COPIED', 'INVITE_QR_DISPLAYED', 'INVITE_LINK_OPENED', 'INVITE_EMAIL_SENT',
  ...
  'MEDIA_VIEW', 'MEDIA_CTA_CLICK', 'MEDIA_RECRUITMENT_CLICK',
  'SEO_AREA_VIEW', 'SEO_GENRE_VIEW', 'SEO_SIGNUP', 'SEO_RECRUITMENT_CREATE',
] as const;
